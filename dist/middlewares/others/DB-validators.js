...
const validateLayerExistance = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        req.gitlabGroupID = (layer === null || layer === void 0 ? void 0 : layer.gitlabId) || null;
        next();
    }
    catch (error) {
        res.status(500).json({
...
const validateRepositoryExistance = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        req.repoGitlabID = (repository === null || repository === void 0 ? void 0 : repository.gitlabId) || null;
        next();
    }
    catch (error) {
        res.status(500).json({
