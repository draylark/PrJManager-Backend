...
], projects_1.postProject);
router.get('/get-project/:userId', projects_1.getProject);
router.get('/get-project-by-id/:projectId', projects_1.getProjectById);
router.put('/update-project/:projectId', projects_1.putProject);
...
router.get('/calculate-progress/:projectId', projects_1.calculateProjectProgress);
